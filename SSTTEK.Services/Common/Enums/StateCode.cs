...
namespace ECommerce.Infrastructure.Common.Enums
{
    public enum StateCode
    {
        ...
        [StateDisplay(Code = 200, Name = "OK", Success = true)]
        Success = 20000,

        #region MAIL


        [StateDisplay(Code = 200, Name = "MailForgotPasswordSendSucces", Success = true)]
        MailForgotPasswordSendSucces = 20100,
        [StateDisplay(Code = 200, Name = "UserForgotPasswordSendSucces", Success = true)]
        ...
        [StateDisplay(Code = 200,  Name = "UserFound", Success = true)]
        UserFound = 20200,        
        [StateDisplay(Code = 200,  Name = "UserChangedPassword", Success = true)]
        UserChangedPassword = 20202,
        [StateDisplay(Code = 201,  Name = "UserCreated", Success = true)]
        UserCreated = 20203,
        [StateDisplay(Code = 204, Name = "UserDeleted", Success = true)]
        UserDeleted = 20204,
        [StateDisplay(Code = 204, Name = "UserUpdated", Success = true)]
        UserUpdated = 20205,
        ...
        [StateDisplay(Code = 400, Name = "Error", Success = false)]
        Error = 40000,
        [StateDisplay(Code = 400,  Name = "UnexpectedError", Success = false)]
        UnexpectedError = 40001,
        [StateDisplay(Code = 400,  Name = "ValidationError", Success = false)]
        ValidationError = 40002,
        [StateDisplay(Code = 400, Name = "WebUIValidationError", Success = false)]
        WebUIUnexpectedError = 40003,
        [StateDisplay(Code = 400,  Name = "ManagementUIValidationError", Success = false)]
        ManagementUIUnexpectedError = 40004,
        [StateDisplay(Code = 400, Name = "APIMobileUnexpectedError", Success = false)]
        APIMobileUnexpectedError = 40005,
        [StateDisplay(Code = 400, Name = "APIPosUnexpectedError", Success = false)]
        APIPosUnexpectedError = 40006,
        [StateDisplay(Code = 400,Name = "NotSendMail", Success = false)]
        NotSendMail = 40007,

        #region USER  


        [StateDisplay(Code = 400,  Name = "WrongUser", Success = false)]
        WrongUser = 40101,

        [StateDisplay(Code = 400,  Name = "InActiveUser", Success = false)]
        InActiveUser = 40107,
        [StateDisplay(Code = 400, Name = "DeletedUser", Success = false)]
        DeletedUser = 40108,
        [StateDisplay(Code = 400, Name = "BlockedUser", Success = false)]
        BlockedUser = 40109,

        #endregion

        #region USER
        [StateDisplay(Code = 404,Name = "UserNotFound", Success = false)]
        UserNotFound = 40200,
        [StateDisplay(Code = 400,  Name = "NotFoundCode", Success = false)]
        NotFoundCode = 40201,
        [StateDisplay(Code = 400,  Name = "UserCodeExpriy", Success = false)]
        UserCodeExpriy = 40202,
        [StateDisplay(Code = 400,  Name = "UserCodeNotCreated", Success = false)]
        UserCodeNotCreated = 40203,
        [StateDisplay(Code = 400,  Name = "UserChangePassword", Success = false)]
        UserChangePassword = 40204,
        [StateDisplay(Code = 400,  Name = "UserPasswordConfirm", Success = false)]
        UserPasswordConfirm = 40205,
        [StateDisplay(Code = 400,  Name = "UserNotUpdate", Success = false)]
        UserNotUpdate = 40206,
        [StateDisplay(Code = 400,Name = "UserNotCreate", Success = false)]
        UserNotCreate = 40207,
        [StateDisplay(Code = 400, Name = "UserFoundSame", Success = false)]
        UserFoundSame = 40208,
        [StateDisplay(Code = 400,  Name = "UserNotSameID", Success = false)]
        UserNotSameID = 40209,
        [StateDisplay(Code = 400,  Name = "UserNotChangedPassword", Success = false)]
