...
{
    public class ContactInformationWriteRepository : WriteRepository<ContactInformation>, IContactInformationWriteRepository
    {
        private readonly SSTTEKWriteContext _context;
        public ContactInformationWriteRepository(SSTTEKWriteContext context) : base(context)
        {
            _context = context;
        }
